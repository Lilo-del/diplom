...
$string['link_gTask'] = 'Генерация заданий с помощью чата GPT';
$string['localhost_gTask'] = 'http://localhost:8888/moodle401/question/type/coderunner/main_page_chatGPT.php';
$string['header_gTask'] = 'Генерация заданий';
$string['HIDE'] = 'Скрыть';
