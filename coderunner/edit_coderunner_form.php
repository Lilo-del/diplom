...
class qtype_coderunner_edit_form extends question_edit_form {
    ...
    protected function generating_task($mform){
        $mform->addElement('header', 'gTask',
                get_string('header_gTask', 'qtype_coderunner'));

        $mform->addElement('html', 'Здесь вы сможете сгенерировать задание, код и тесты к этому заданию с помощью ChatGPT.<br>Для более простой и точной генерации задании в чат был вcтроен шаблон, поэтому вам всего лишь потребуется ввести запрос ввиде:<br> "Задание на "Тема задания"(Например работа со строками, массивы, числа и тд.) на языке программирования "Нужный вам язык программирования"" ');
        
        $mform->addElement('link', 'site', '', get_string('localhost_gTask', 'qtype_coderunner'), get_string('link_gTask', 'qtype_coderunner'));
